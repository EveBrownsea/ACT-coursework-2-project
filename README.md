...
The goal of the project is to create two methods for predicting whether or not a fusion process will undergo ignition, i.e. if it will become self-sustaining. For each input dataset, the output will be a 1 (Ignition) or a 0 (No ignition). 
